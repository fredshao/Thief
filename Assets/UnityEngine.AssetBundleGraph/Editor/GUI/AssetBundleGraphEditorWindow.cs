		...
		*/
		...
		public static void BuildFromMenu () {
            ...
            */
            ...
            if (HardwareUtil.IsWindows()) {
                GenerateBundleInfo.CopyBundle();
            } else {
                EditorUtility.DisplayDialog("Warning", "Bundle已经导出完成，请手动拷贝到提交目录，然后提交", "好的");
            }
        ...
        public static void BuildFromEditorScripts(BuildTarget _target) {
            var window = GetWindow<AssetBundleGraphEditorWindow>();
		...
		private void Run () {
			...
			try {
				...
				if(!controller.IsAnyIssueFound) {
                    GenerateBundleInfo.buildTarget = target;
